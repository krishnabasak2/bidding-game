                                ...
                                {{-- <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single w-100 form-control" id="select"
                                                name="phone">
                                                <option value="AL" disabled>Select</option>
                                            </select>
                                        </div>
                                    </div>
                                </div> --}}
                                ...
                                <table id="data-table-1" class="table table-hover table-responsive display">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ ((($data['status'] == '0' ? 'Bidding' : $data['status'] == '1') ?
                                                'Winning' : $data['status'] == '2') ? 'Deposit' : $data['status'] ==
                                                '3') ? 'Payout' : 'By Admin' }}
                                            </td>
