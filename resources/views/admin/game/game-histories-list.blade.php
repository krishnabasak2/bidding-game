                                    ...
                                    <table id="data-table-1" class="table table-hover table-responsive display">
                                        <thead class="thead-primary">
                                            <tr>
                                                ...
                                                <th>Bid Amount</th>
                                                <th>Won Amount</th>
                                                <th>Single Win Number</th>
                                                <th>Patti Win Number</th>
                                                <th>Jodi Win Number</th>
                                                <th>Manage</th>
                                            </tr>
                                        </thead>
                                        @if (!empty($data_list))
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($site_data->currency_value > 1)
                                                                <small>
                                                                    (₹
                                                                    {{ round($data->bid->sum('bid_amount') / $site_data->currency_value, 2) }})
                                                                </small>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            ...
                                                            @if ($site_data->currency_value > 1)
                                                                <small>
                                                                    (₹
                                                                    {{ round($data->bid->sum('won_amount') / $site_data->currency_value, 2) }})
                                                                </small>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($data['status'] == '0' && ($data['patti_win_value'] || $data['single_win_value']))
